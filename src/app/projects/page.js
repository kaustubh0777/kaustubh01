        ...
        <>
            ...
            <div className=' mx-auto justify-center items-center flex mb-20'>
                <div className='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3'>
                    ...
                    <div className=" w-full h-full transition-all duration-700 hover:scale-110 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-5 ">
                            ...
                            <div className='flex justify-center items-center'>
                                <a href="https://github.com/kaustubh0777/Ticketing_App" className=" mr-2 inline-flex items-center px-3 py-2 text-sm mt-2 
                    ...
                    <div className=" w-full h-full transition-all duration-700 hover:scale-110 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="p-5 ">
                            <a href="#">
                                <h5 className="shadow-lg transition-all duration-700 hover:scale-110mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">MarkDown Editor</h5>
                            </a>
                    ...
                    <div className="w-full h-full transition-all duration-700 hover:scale-110 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="p-5 ">
                            ...
                            <div className='flex justify-center items-center'>
                                ...
                                <a href="https://infallible-nightingale-2dd5fa.netlify.app/" className=" mt-2 mr-2 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    Demo
                                    <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                                    </svg>
                    ...
                    <div className="w-full h-full transition-all duration-700 hover:scale-110 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="p-5 ">
                            ...
                            <div className='flex justify-center items-center'>
                                ...
                                <a href="https://cute-semolina-90e681.netlify.app/" className="mt-2 mr-2 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    Demo
                                    <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                                    </svg>
